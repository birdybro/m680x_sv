...
For the base MC6800 profile, 107 two-cycle, immediate, direct-read, and
extended-read/JMP encodings carry complete structured Table-8 bus traces. The
model and RTL compare every cycle, including the otherwise non-architectural
read of the next opcode address for two-cycle operations. These facts are not

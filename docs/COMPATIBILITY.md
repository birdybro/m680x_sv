...
for 107 two-cycle, immediate, direct-read, and extended-read/JMP encodings,
including the next-opcode-address read that is not architecturally consumed. Remaining

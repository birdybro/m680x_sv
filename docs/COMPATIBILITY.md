...
for 115 two-cycle, immediate, direct/extended data, and extended-JMP encodings,
including the next-opcode-address read and VMA-low pre-write cycles. Remaining

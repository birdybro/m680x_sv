...
for 183 two-cycle, immediate, direct, indexed, extended, and relative
encodings, including next-opcode, partial indexed-address, JSR-prefetch, and
VMA-low cycles. Remaining

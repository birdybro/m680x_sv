...
bus traces for 121 table-G2 inherent, accumulator, immediate, relative, bit, and
direct encodings, including BSR/RTS/RTI/SWI; the remaining addressing-mode rows and

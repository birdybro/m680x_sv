...
module tb_hd6301v1_bus_wrapper;
  ...
  initial begin
    ...
    advance_phase(2'd1);
    advance_phase(2'd2);
    check_value(!sc2[6], "Mode 7 OS3 starts at the selected positive E edge");
    advance_phase(2'd3);
    check_value(!sc2[6], "Mode 7 OS3 remains active after E falls");
    advance_phase(2'd0);
    check_value(!sc2[6], "Mode 7 OS3 spans the complete E cycle");
    set_transaction(16'h0002, 1'b0, 8'h00);
    advance_phase(2'd1);
    check_value(!sc2[6], "Mode 7 OS3 remains active until the next positive E edge");
    advance_phase(2'd2);
    check_value(sc2[6], "Mode 7 OS3 ends at the next positive E edge");
    advance_phase(2'd3);
    advance_phase(2'd0);
